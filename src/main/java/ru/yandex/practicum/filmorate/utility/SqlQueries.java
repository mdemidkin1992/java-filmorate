...
public final class SqlQueries {
    ...
    public static final String GET_FILM_DIRECTORS = "SELECT d.* FROM FILMS_DIRECTORS fd JOIN DIRECTORS d ON fd.DIRECTOR_ID = d.DIRECTOR_ID WHERE fd.FILM_ID = ? ORDER BY d.DIRECTOR_ID";
    ...
    public static final String GET_DIRECTORS_FOR_ALL_FILMS = "SELECT * FROM FILMS_DIRECTORS fd JOIN DIRECTORS d ON fd.DIRECTOR_ID = d.DIRECTOR_ID";
    public static final String FIND_FILMS_BY_NAME = "SELECT * FROM FILMS f LEFT JOIN (SELECT l.FILM_ID, COUNT(l.USER_ID) AS likes_count FROM LIKES l GROUP BY l.FILM_ID) temp ON f.FILM_ID = temp.FILM_ID WHERE LOWER(f.FILM_NAME) LIKE ? ORDER BY temp.LIKES_COUNT DESC";
    public static final String FIND_FILMS_BY_DIRECTOR = "SELECT f.* FROM FILMS f LEFT JOIN (SELECT l.FILM_ID, COUNT(l.USER_ID) AS likes_count FROM LIKES l GROUP BY l.FILM_ID) temp ON f.FILM_ID = temp.FILM_ID LEFT JOIN FILMS_DIRECTORS fd on f.FILM_ID = fd.FILM_ID LEFT JOIN DIRECTORS d on fd.DIRECTOR_ID = d.DIRECTOR_ID WHERE LOWER(d.DIRECTOR_NAME) LIKE ? ORDER BY temp.LIKES_COUNT DESC";
    public static final String FIND_FILMS_BY_NAME_OR_DIRECTOR = "SELECT f.* FROM FILMS f LEFT JOIN (SELECT l.FILM_ID, COUNT(l.USER_ID) AS likes_count FROM LIKES l GROUP BY l.FILM_ID) temp ON f.FILM_ID = temp.FILM_ID LEFT JOIN FILMS_DIRECTORS fd on f.FILM_ID = fd.FILM_ID LEFT JOIN DIRECTORS d on fd.DIRECTOR_ID = d.DIRECTOR_ID WHERE LOWER(d.DIRECTOR_NAME) LIKE ? OR LOWER(f.FILM_NAME) LIKE ? ORDER BY temp.LIKES_COUNT DESC";
    public static final String FIND_ALL_FILMS_BY_DIRECTOR_SORTED_BY_LIKES = "SELECT f.FILM_ID, f.FILM_NAME, f.DESCRIPTION, f.RELEASE_DATE, f.DURATION, f.RATING_ID FROM FILMS f LEFT JOIN (SELECT l.FILM_ID, COUNT(l.USER_ID) likes_count FROM LIKES l GROUP BY l.FILM_ID) temp ON f.FILM_ID = temp.FILM_ID LEFT JOIN FILMS_DIRECTORS fd ON f.FILM_ID = fd.FILM_ID WHERE DIRECTOR_ID = ? ORDER BY temp.LIKES_COUNT DESC";
    public static final String FIND_ALL_FILMS_BY_DIRECTOR_SORTED_BY_YEAR = "SELECT f.FILM_ID, f.FILM_NAME, f.DESCRIPTION, f.RELEASE_DATE, f.DURATION, f.RATING_ID FROM FILMS f LEFT JOIN (SELECT l.FILM_ID, COUNT(l.USER_ID) likes_count FROM LIKES l GROUP BY l.FILM_ID) temp ON f.FILM_ID = temp.FILM_ID LEFT JOIN FILMS_DIRECTORS fd ON f.FILM_ID = fd.FILM_ID WHERE DIRECTOR_ID = ? ORDER BY EXTRACT(YEAR FROM CAST(RELEASE_DATE AS DATE))";
