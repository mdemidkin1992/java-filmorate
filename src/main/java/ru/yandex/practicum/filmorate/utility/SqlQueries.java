...
public final class SqlQueries {
    ...
    public static final String FIND_FILMS_BY_DIRECTOR = "SELECT * FROM FILMS f LEFT JOIN (SELECT l.FILM_ID, COUNT(l.USER_ID) AS likes_count FROM LIKES l GROUP BY l.FILM_ID) temp ON f.FILM_ID = temp.FILM_ID WHERE LOWER(f.FILM_NAME) LIKE ? ORDER BY temp.LIKES_COUNT DESC";
