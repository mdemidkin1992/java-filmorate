...
public final class SqlQueries {
    ...
    public static final String GET_FILMS_WITH_GENRES = "SELECT * FROM FILMS f JOIN RATINGS r ON f.RATING_ID = r.RATING_ID LEFT JOIN FILMS_GENRES fg ON f.FILM_ID = fg.FILM_ID LEFT JOIN GENRES g ON g.GENRE_ID = fg.GENRE_ID";
    ...
    public static final String GET_POPULAR_FILMS_WITH_GENRES = "SELECT * FROM FILMS f LEFT JOIN (SELECT l.FILM_ID, COUNT(l.USER_ID) AS likes_count FROM LIKES l GROUP BY l.FILM_ID) temp ON f.FILM_ID = temp.FILM_ID LEFT JOIN RATINGS r ON f.RATING_ID = r.RATING_ID LEFT JOIN FILMS_GENRES fg ON f.FILM_ID = fg.FILM_ID LEFT JOIN GENRES g ON g.GENRE_ID = fg.GENRE_ID ORDER BY temp.LIKES_COUNT DESC";
